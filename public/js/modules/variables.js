...
const filterThemeResultsBtn = document.querySelector(
  ".filter-theme-results-btn"
);
...
const ambassadorsIconValue = document.querySelectorAll(".thumbnail-container .statistics li:nth-child(1) span");
const helperIconValue = document.querySelectorAll(".thumbnail-container .statistics li:nth-child(2) span ");
const votersIconValue = document.querySelectorAll(".thumbnail-container .statistics li:nth-child(3) span ");
...
export {
  ...
  imagePreview,
  uploadButton,
  filterThemeResultsBtn,
  filterSortResultsBtn,
  boxes,
  titleInput,
  descriptionTextarea,
  helperIconValue,
